...
void ::AWU::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::AWU::App::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return _AppProvider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::AWU::App::GetXamlType(::Platform::String^ fullName)
{
    return _AppProvider->GetXamlTypeByName(fullName);
}

::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::AWU::App::GetXmlnsDefinitions()
{
    return ref new ::Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::AWU::App::_AppProvider::get()
{
